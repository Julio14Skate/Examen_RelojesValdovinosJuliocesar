...
function draw() {
  background(255);
  dibujarReloj(width / 4, height / 2, offsetHora1, "La Paz");
  dibujarReloj(width / 2, height / 2, offsetHora1 + diferenciasHorarias[1], "Ciudad de México");
  dibujarReloj(3 * width / 4, height / 2, offsetHora1 + diferenciasHorarias[2], "Barcelona");
}
